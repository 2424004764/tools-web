...
export const constantRoute = [
  //首页
  {
    ...
    name: 'home',
    meta: {
      keywords: '在线工具,开发运维,文本处理,图片处理,数据图表,趣味互动,选择随机,教育学术,内容管理,AI工具,好物网站,收藏夹,稍后读,书签管理,链接收藏,JSON转换,CSV,TSV,随机密码,UUID,时间戳转换,进制转换,单位换算,复利计算器,复利,定投,URL编码,URL参数,正则测试,Markdown,文本对比,文本去重,哈希,HMAC,Base64,Base64编码,Base64解码,文件大小转换,HTTP状态码,JWT解析,Cron生成,HTML实体,二维码生成,二维码识别,图片编辑,图片分割,图片转Base64,Base64转图片,文本转图片,色板,取色器,柱状图,折线图,饼图,散点图,摩斯电码,贪吃蛇,2048,俄罗斯方块,扫雷,打地鼠,数字华容道,数独,IP查询,网站信息,AI起名,AI变量名,文生图,AI翻译,Postman',
      description: '一站式在线工具箱：覆盖开发运维、文本处理、图片处理、数据图表、趣味互动、选择随机、教育学术与 AI 工具；提供 JSON/CSV/TSV 互转、随机密码/UUID、时间戳与进制转换、单位换算、复利计算、URL 编解码/参数解析、正则测试、Markdown、文本对比/去重、Base64 编解码、哈希校验、文件大小转换、HTTP 状态码、JWT 解析、Cron 表达式、HTML 实体、二维码生成与识别、在线图片编辑/分割、图片与 Base64 双向互转、文本转图片、色板取色器、柱状/折线/饼/散点图、摩斯电码，以及贪吃蛇/2048/俄罗斯方块/扫雷/打地鼠/数字华容道/数独等小游戏，另含 IP 查询、网站信息获取、AI 起名/变量名/文生图/翻译与在线请求调试等实用功能。另附收藏夹与稍后读功能方便管理网络链接。'
    }
  },
  // 用户信息页
  {
  ...
  // 分类工具列表页（设计稿2：单分类网格视图），标题由 CategoryPage 在挂载后按分类动态覆写
  {
    path: '/cate/:id',
    component: () => import('@/components/Home/CategoryPage.vue'),
    name: 'cate',
    meta: {
      title: '分类工具',
      keywords: '工具分类,在线工具,工具箱',
      description: '按分类浏览在线工具箱中的全部工具',
    }
  },
  {
    //重定向
  ...
  },
  {
    ...
    component: () => import('@/components/Tools/CompoundInterest/CompoundInterest.vue'),
    name: 'compoundInterest',
    meta: {
      title: '复利计算器',
      keywords: '复利计算器,复利计算,定投计算器,复利终值,单利对照,72法则,年化利率,本金倒推,投资年限,复利频率',
      description: '在线复利计算器：输入本金、年利率、年限与定投，实时计算复利终值并对照单利；支持倒推本金/年限/利率、年度明细表与增长曲线，纯前端运算保护隐私。',
    }
  },
  {
    path: '/code-image/',
