  ...
  <div class="flex space-x-2">
    <div class="flex-1">
      <textarea
        ...
        @input="handleInput"
        placeholder="输入您的问题..."
        class="w-full px-4 py-2 border border-border-subtle rounded-lg resize-none bg-surface-0 text-ink-900 placeholder:text-ink-400 focus:outline-none focus:ring-2 focus:ring-accent-500 focus:border-transparent transition-colors"
        :class="loading ? 'bg-surface-1 cursor-not-allowed' : ''"
        :disabled="false"
        rows="1"
