...
const renderChart = () => {
  ...
  const option = {
    ...
    legend: { data: series.map(s => s.name), bottom: 0, textStyle: { color: axisLabelColor } },
...
import DataLine from '~icons/ep/dataLine'
...
html.dark .from-cyan-50.to-blue-50 {
  background-image: linear-gradient(to right, rgb(6 182 212 / 0.12), rgb(59 130 246 / 0.05));
}
html.dark .from-blue-50.to-indigo-50 {
  background-image: linear-gradient(to bottom right, rgb(59 130 246 / 0.12), rgb(99 102 241 / 0.05));
}
