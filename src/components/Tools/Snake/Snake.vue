    ...
    <div class="p-6 rounded-2xl bg-white shadow-sm border border-gray-200">
      <div class="max-w-2xl mx-auto">
        ...
        <div class="flex justify-between items-center mb-6">
          <div class="text-center bg-blue-50 p-4 rounded-lg border border-blue-200 flex-1 mx-2">
            <h3 class="text-lg font-medium text-blue-900">得分</h3>
            <p class="text-2xl font-bold text-blue-600">{{ gameState.score }}</p>
          </div>
        ...
        <div class="flex justify-center mb-6">
          ...
          >
            ...
            <div
              ...
              :key="index"
              class="absolute bg-green-500 shadow-sm"
              :style="{
            ...
            >
              <!-- 蛇头 -->
              <div v-if="index === 0" class="w-full h-full bg-green-600 rounded-sm"></div>
            </div>
            
            <!-- 食物 -->
            <div
              class="absolute bg-red-500 rounded-full shadow-md animate-pulse"
              :style="{
        ...
        <div class="lg:hidden flex justify-center mb-6">
          <div class="bg-gray-100 rounded-lg p-4 border border-gray-300">
            <h3 class="text-center text-sm font-medium text-gray-700 mb-3">方向控制</h3>
        ...
        <div class="bg-gray-50 rounded-lg p-4 border-2 border-gray-200 shadow-sm">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-600">
            <div class="bg-white p-3 rounded border border-gray-200">
              <p><strong class="text-blue-600">方向键/WASD：</strong>控制蛇的移动方向</p>
              <p><strong class="text-blue-600">空格键：</strong>暂停/继续游戏</p>
            </div>
            <div class="bg-white p-3 rounded border border-gray-200">
              <p><strong class="text-green-600">目标：</strong>吃到红色食物，让蛇变长</p>
              <p><strong class="text-red-600">注意：</strong>不要撞墙或撞到自己</p>
            </div>
          </div>
          <!-- H5端操作说明 -->
          <div class="lg:hidden mt-4 bg-blue-50 p-3 rounded border border-blue-200">
